...
### Prerequisites
- Redaxo CMS version ^5.18.3
- Supported Redaxo CMS 4.0 to 5.0 versions

### Steps

- Load via installer or unzip the zip file in the add-on folder, the folder must be called "allinoneaccessibility" 
- Go to **AddOns** section and select "All in One Accessibility"
- Click **Install** Button
- To Configure the Setting navigate to AddOns->All in One Accessibility
...
## Live Demo
https://redaxocms.skynettechnologies.us
